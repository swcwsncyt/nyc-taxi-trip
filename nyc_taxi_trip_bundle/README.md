...
The 'nyc_taxi_trip_bundle' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/nyc_taxi_trip_bundle_etl`: Pipeline code and assets for the nyc_taxi_trip_bundle_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] nyc_taxi_trip_bundle_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/nyc_taxi_trip_bundle_etl/nyc_taxi_trip_bundle_job.job.yml). The schedule
